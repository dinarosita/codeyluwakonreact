...
export default function ChildComponent3Code() {
  return (
    <Codebox title="ChildComponent.js">
      import React,{" "}
      <Curly>
        {" "}
        <Imp>useTheme</Imp>, <Imp>useThemeUpdate</Imp>{" "}
      </Curly>{" "}
      from "react"
      <Space />
      export default <Imp>function</Imp> <Fn>ChildComponent</Fn>(){" "}
      <CurlyTab>
        const <Var>darkTheme</Var> = <Imp>useTheme()</Imp>
        <br />
        const <Var>toggleTheme</Var> = <Imp>useThemeUpdate()</Imp>
        <Space />
